		...
		function restrictPlayer(){
			for(i=0;i<mazePathX.length-1;i+=2){
				if(i>=666){
					...
					var d; // koren iz katete 1 in katete 2 => kateta 1=playerR  kateta 2=X točka črte		***Omejevanje Y prečne črte***
...
/** INIT **/
    ...
    function finishGame(){
        gameOver = true;
        alert("YAAAY CAT NO LONGER HUNGRY!");
    }
